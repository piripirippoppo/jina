...
const startBss = async () => {
    ...
    await comnFunc.screenCapture("1_after-login", page, process.env.SRCEENSHOT_PATH);
    ...
    await comnFunc.screenCapture("2_After-Search-Person", popup, process.env.SRCEENSHOT_PATH);
    ...
    await comnFunc.screenCapture("3_After-Selection-Row", popup, process.env.SRCEENSHOT_PATH);
    ...
    await comnFunc.screenCapture("4_After-Save-Person", popup, process.env.SRCEENSHOT_PATH);
